		...
		$_sub_giro
			...
			if($_tipo_imagen==="cliente"){
				...
				$array=array(
					...
					"P_Obt_Socioambiental"=>$_puntos_ob_socioambiental,
					"P_Pos_Socioambiental"=>$_puntos_pos_socioambiental,
					"P_Obt_Sanidad"=>$_puntos_ob_sanidad,
					"P_Pos_Sanidad"=>$_puntos_pos_sanidad,
					"Ultima_Media"=>$num,
					"Fecha"=>date('Y-m-d'),
					"IDGiro"=>$_sub_giro
					);
