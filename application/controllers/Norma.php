...
class Norma extends REST_Controller
{
	...
	public function update_post(){
		...
		$this->form_validation->set_message($array);
			if($this->form_validation->run() !=false){
				//ahora guardo la norma
				$this->Model_Norma->UpdateCert($_POST["IDNorma"],$_POST["Norma"],$_POST["Fecha"],$_POST["Calificacion"],$nombreactual);
				$_data["code"]=0;
				$_data["ok"]="SUCCESS";
				$_data["result"]=$this->Model_Norma->getall($_ID_Empresa);
			}else{
	...
	public function save_post(){
		...
		$this->form_validation->set_message($array);
			if($this->form_validation->run() !=false){
				//ahora guardo la norma
				$this->Model_Norma->save($_ID_Empresa,$_POST["Norma"],$_POST["Fecha"],$_POST["Calificacion"],$nombreactual);
				$_data["code"]=0;
				$_data["ok"]="SUCCESS";
				$_data["result"]=$this->Model_Norma->getall($_ID_Empresa);
			}else{
